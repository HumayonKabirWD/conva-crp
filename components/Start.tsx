...
const Start = () => {
  return (
      ...
      <Link href="/" className="absolute mt-20 ml-20 scale-up1">
      ...
      <div className="flex flex-col items-center justify-center absolute mt-72 text-center">
        <h1 className="mx-0 lg:mx-20 text-balance text-6xl md:text-6xl lg:text-8xl uppercase italic font-bold text-[#C43B92] scale-up2">describing the future</h1>
        <button className="mt-20 bg-[#C43B92] py-2 px-5 hover:scale-105 rounded-md font-bold scale-up3">Learn More</button>
      </div>
